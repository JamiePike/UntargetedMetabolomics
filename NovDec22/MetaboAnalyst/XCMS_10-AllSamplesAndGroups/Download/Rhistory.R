...
mSet<-ANOVA.Anal(mSet, F, 0.2, FALSE)
mSet<-PlotANOVA(mSet, "aov_2_", "png", 72, width=NA)
mSet<-ANOVA.Anal(mSet, F, 0.2, FALSE)
mSet<-PlotANOVA(mSet, "aov_3_", "png", 72, width=NA)
mSet<-Calculate.ANOVA.posthoc(mSet, "tukey", 0.05)
mSet<-PlotSubHeatMap(mSet, "heatmap_2_", "png", 72, width=NA, "norm", "row", "euclidean", "ward.D","bwm", 8, "tanova", 158, "overview", T, T, T, F, T, T, T)
mSet<-PCA.Anal(mSet)
