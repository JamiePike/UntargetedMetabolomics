...
feature.nm.vec <- c("")
smpl.nm.vec <- c("X34.F9.2.neg","X46.F9.4.neg","X09.X12.3.neg","X44.D12.1.neg")
...
mSet<-PlotSubHeatMap(mSet, "heatmap_2_", "png", 72, width=NA, "norm", "row", "euclidean", "ward.D","bwm", 8,8, 10.0,0.02,10, 10, "tanova", 453, T, T, T, F, T, T, T,T,"overview")
