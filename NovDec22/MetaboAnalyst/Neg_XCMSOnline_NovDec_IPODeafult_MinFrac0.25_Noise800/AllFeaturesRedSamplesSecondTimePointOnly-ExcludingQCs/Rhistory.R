...
mSet<-PlotCmpdSummary(mSet, "M497.175T1191.749","NA","NA", 0, "png", 72)
mSet<-SetCmpdSummaryType(mSet, "boxplot")
mSet<-PlotCmpdSummary(mSet, "M497.175T1191.749","NA","NA", 1, "png", 72)
mSet<-ANOVA.Anal(mSet, F, 0.10616, FALSE)
mSet<-PlotANOVA(mSet, "aov_2_", "png", 72, width=NA)
mSet<-Calculate.ANOVA.posthoc(mSet, "fisher", 0.05)
mSet<-ANOVA.Anal(mSet, F, 10.0, FALSE)
mSet<-PlotANOVA(mSet, "aov_3_", "png", 72, width=NA)
mSet<-Calculate.ANOVA.posthoc(mSet, "fisher", 1.0)
mSet<-ANOVA.Anal(mSet, F, 0.10778, FALSE)
...
mSet<-PlotSubHeatMap(mSet, "heatmap_2_", "png", 72, width=NA, "norm", "row", "euclidean", "ward.D","bwm", 8,8, 10.0,0.02,10, 10, "tanova", 1005, T, T, T, F, T, T, T,T,"overview")
