...
mSet<-UpdateLoadingCmpd(mSet, "M516.992T825.04")
mSet<-SetCmpdSummaryType(mSet, "violin")
mSet<-PlotCmpdSummary(mSet, "M516.992T825.04","NA","NA", 0, "png", 72)
mSet<-SetCmpdSummaryType(mSet, "boxplot")
mSet<-PlotCmpdSummary(mSet, "M516.992T825.04","NA","NA", 1, "png", 72)
...
mSet<-PlotVolcano(mSet, "volcano_1_",1, 0, "pdf", 72, width=NA)
