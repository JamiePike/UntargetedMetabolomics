...
grp.nm.vec <- c("Second-tp_Control","Second-tp_Drought","Second-tp_Fusarium","Second-tp_Xanthomonas")
...
mSet<-ANOVA.Anal(mSet, T, 0.051556, FALSE)
...
mSet<-ANOVA.Anal(mSet, T, 0.13166, FALSE)
...
mSet<-PlotSubHeatMap(mSet, "heatmap_2_", "png", 72, width=NA, "norm", "row", "euclidean", "ward.D","bwm", 8,8, 10.0,0.02,10, 10, "tanova", 801, T, T, T, F, T, T, T,T,"overview")
mSet<-PlotSubHeatMap(mSet, "heatmap_2_", "pdf", 72, width=NA, "norm", "row", "euclidean", "ward.D","bwm", 8,8, 10.0,0.02,10, 10, "tanova", 801, T, T, T, F, T, T, T,T,"overview" , T)
