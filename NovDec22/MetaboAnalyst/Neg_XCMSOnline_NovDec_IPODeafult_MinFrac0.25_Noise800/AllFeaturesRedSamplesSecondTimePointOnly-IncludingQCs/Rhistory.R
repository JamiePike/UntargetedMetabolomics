...
feature.nm.vec <- c("")
smpl.nm.vec <- c("X09.X12.3.neg","X44.D12.1.neg")
...
mSet<-ANOVA.Anal(mSet, F, 0.13028, FALSE)
...
mSet<-PlotSubHeatMap(mSet, "heatmap_2_", "png", 72, width=NA, "norm", "row", "euclidean", "ward.D","bwm", 8,8, 10.0,0.02,10, 10, "tanova", 836, T, T, T, F, T, T, T,T,"overview")
