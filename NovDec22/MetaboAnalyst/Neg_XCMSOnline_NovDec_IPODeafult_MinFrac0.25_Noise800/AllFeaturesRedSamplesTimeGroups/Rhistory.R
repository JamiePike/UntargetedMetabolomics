...
feature.nm.vec <- c("")
smpl.nm.vec <- c("")
grp.nm.vec <- c("First-tp","Other","Second-tp")
...
mSet<-ANOVA.Anal(mSet, F, 1.3013, FALSE)
mSet<-PlotANOVA(mSet, "aov_2_", "png", 72, width=NA)
mSet<-Calculate.ANOVA.posthoc(mSet, "fisher", 0.05)
mSet<-ANOVA.Anal(mSet, F, 0.15135, FALSE)
...
mSet<-PlotSubHeatMap(mSet, "heatmap_2_", "png", 72, width=NA, "norm", "row", "euclidean", "ward.D","bwm", 8,8, 10.0,0.02,10, 10, "tanova", 720, T, T, T, F, T, T, T,T,"overview")
