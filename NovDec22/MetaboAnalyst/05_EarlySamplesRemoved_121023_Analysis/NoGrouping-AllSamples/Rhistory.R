...
mSet<-ANOVA.Anal(mSet, F, 0.39688, FALSE)
...
mSet<-PlotSubHeatMap(mSet, "heatmap_2_", "png", 72, width=NA, "norm", "row", "euclidean", "ward.D","bwm", 8,8, 10.0,0.02,10, 10, "tanova", 143, T, T, T, F, T, T, T,T,"overview")
mSet<-PCA.Anal(mSet)
