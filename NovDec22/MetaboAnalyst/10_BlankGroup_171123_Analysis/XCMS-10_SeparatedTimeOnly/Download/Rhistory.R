...
feature.nm.vec <- c("")
smpl.nm.vec <- c("")
grp.nm.vec <- c("First","Second","Third")
...
mSet<-ANOVA.Anal(mSet, F, 0.1043, FALSE)
...
mSet<-Calculate.ANOVA.posthoc(mSet, "tukey", 0.05)
mSet<-ANOVA.Anal(mSet, F, 0.95057, FALSE)
...
mSet<-PlotSubHeatMap(mSet, "heatmap_2_", "png", 72, width=NA, "norm", "row", "euclidean", "ward.D","bwm", 8, "tanova", 68, "overview", T, T, T, F, T, T, T)
