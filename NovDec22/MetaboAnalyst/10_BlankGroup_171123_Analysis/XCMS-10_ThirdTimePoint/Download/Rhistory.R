...
feature.nm.vec <- c("")
smpl.nm.vec <- c("")
grp.nm.vec <- c("con_15","foc_15","xvm_15","dro_15")
...
mSet<-ANOVA.Anal(mSet, F, 0.73398, FALSE)
...
mSet<-Calculate.ANOVA.posthoc(mSet, "tukey", 0.05)
mSet<-ANOVA.Anal(mSet, F, 0.73399, FALSE)
...
mSet<-PlotSubHeatMap(mSet, "heatmap_2_", "png", 72, width=NA, "norm", "row", "euclidean", "ward.D","bwm", 8, "tanova", 61, "overview", T, T, T, F, T, T, T)
