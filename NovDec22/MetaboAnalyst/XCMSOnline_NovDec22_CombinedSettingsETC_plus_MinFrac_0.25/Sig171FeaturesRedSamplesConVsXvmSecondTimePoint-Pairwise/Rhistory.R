...
mSet<-PlotHeatMap(mSet, "heatmap_1_", "png", 72, width=NA, "norm", "row", "euclidean", "ward.D","bwm", 12,8, 10.0,0.02,20, 10, T, T, NULL, T, F, T, T,  T,T)
mSet<-PlotHeatMap(mSet, "heatmap_2_", "png", 72, width=NA, "norm", "row", "euclidean", "ward.D","bwm", 12,8, 10.0,0.02,20, 10, T, T, NULL, T, F, T, T,  T,F)
mSet<-PlotSubHeatMap(mSet, "heatmap_3_", "png", 72, width=NA, "norm", "row", "euclidean", "ward.D","bwm", 12,8, 10.0,0.02,20, 5, "tanova", 48, T, T, T, F, T, T, T,T,"overview")
