...
mSet<-UpdateLoadingCmpd(mSet, "M659.418T1406.262")
mSet<-SetCmpdSummaryType(mSet, "violin")
mSet<-PlotCmpdSummary(mSet, "M659.418T1406.262","NA","NA", 0, "png", 72)
mSet<-UpdateLoadingCmpd(mSet, "M609.455T1145.906")
mSet<-SetCmpdSummaryType(mSet, "violin")
mSet<-PlotCmpdSummary(mSet, "M609.455T1145.906","NA","NA", 1, "png", 72)
mSet<-Volcano.Anal(mSet, FALSE, 2.0, 0, F, 0.1, FALSE, "raw")
...
mSet<-Volcano.Anal(mSet, FALSE, 2.0, 1, F, 0.1, FALSE, "raw")
mSet<-PlotVolcano(mSet, "volcano_4_",1, 0, "png", 72, width=NA)
