...
mSet<-PlotSubHeatMap(mSet, "heatmap_2_", "png", 72, width=NA, "norm", "row", "euclidean", "ward.D","bwm", 12,8, 10.0,0.02,20, 3, "tanova", 171, T, T, T, F, T, T, T,T,"overview")
mSet<-GetGroupNames(mSet, "null")
colVec<-c("##2adc36","#NA","#NA","#NA")
shapeVec<-c(0,0,0,0)
mSet<-UpdateGraphSettings(mSet, colVec, shapeVec)
colVec<-c("##2adc36","##b3ff9e","##3594ee","##abe0ff")
shapeVec<-c(0,0,0,0)
mSet<-UpdateGraphSettings(mSet, colVec, shapeVec)
mSet<-PlotSubHeatMap(mSet, "heatmap_2_", "png", 300, width=NA, "norm", "row", "euclidean", "ward.D","bwm", 12,8, 10.0,0.02,20, 3, "tanova", 171, T, T, T, F, T, T, T,T,"overview" , T)
mSet<-PlotSubHeatMap(mSet, "heatmap_2_", "pdf", 72, width=NA, "norm", "row", "euclidean", "ward.D","bwm", 12,8, 10.0,0.02,20, 3, "tanova", 171, T, T, T, F, T, T, T,T,"overview" , T)
