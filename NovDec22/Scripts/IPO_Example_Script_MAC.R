...
setwd("~/u1983390/Banana_LC-MS/IPO/")
# Change path to location of data files.
datafiles <- list.files("./IPO_Input", recursive = TRUE, full.names = TRUE)
...
time.xcmsSet <- system.time({ # measuring time
  resultPeakpicking <- 
    optimizeXcmsSet(files = datafiles[1:32], # Enter the number of files. 
