...
setwd("/Volumes/Jamie_EXT/Projects/Metabolomics/NovDec22/XCMS/09_BlankWithQCs_161123")
datafiles <- list.files("/Volumes/Jamie_EXT/Projects/Metabolomics/NovDec22/XCMS/09_BlankWithQCs_161123", recursive = TRUE, full.names = TRUE)
