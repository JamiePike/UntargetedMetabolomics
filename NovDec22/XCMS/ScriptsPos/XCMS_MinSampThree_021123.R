...
setwd("/Volumes/Jamie_EXT/Research/Metabolomics/NovDec22/XCMS/06_EarlySamplesRemoved_011123")
datafiles <- list.files("/Volumes/Jamie_EXT/Research/Metabolomics/NovDec22/XCMS/06_EarlySamplesRemoved_011123", recursive = TRUE, full.names = TRUE)
...
xset <- group( 
  ...
  mzwid   = 0.0265,
  minfrac = 0.75, #Changed to 0.75
  minsamp = 1, #Changed to 3.
  max     = 50)
