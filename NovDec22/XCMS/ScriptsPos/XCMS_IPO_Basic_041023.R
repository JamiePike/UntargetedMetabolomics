...
setwd("/Volumes/Jamie_EXT/Research/Metabolomics/NovDec22/XCMS/01_IPO-Basic_041023")
datafiles <- list.files("/Volumes/Jamie_EXT/Research/Metabolomics/NovDec22/XCMS/01_IPO-Basic_041023", recursive = TRUE, full.names = TRUE)
