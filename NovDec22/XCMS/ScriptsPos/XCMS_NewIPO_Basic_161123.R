...
setwd("/Volumes/Jamie_EXT/Projects/Metabolomics/NovDec22/XCMS/08_NewIPO_161123")
datafiles <- list.files("/Volumes/Jamie_EXT/Projects/Metabolomics/NovDec22/XCMS/08_NewIPO_161123", recursive = TRUE, full.names = TRUE)
